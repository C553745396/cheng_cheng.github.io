...
function loading(){
	if($('#loaddiv').length<=0){
		$(document.body).append('<div id="loaddiv" style="text-align:center;position:fixed;top:100px;width:100%;"><div style="display:inline-block;padding:10px;border-radius:5px;"><img src="../img/loading.gif" style="width:50px;" /></div></div>');
	}
	$('#loaddiv').show();
}
