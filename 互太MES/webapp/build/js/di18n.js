(function webpackUniversalModuleDefinition(root, factory) {
	...
	//IE8兼容改
	//Object.create兼容ES5
	if (isIE8 && !Object.create) {
		Object.create = function(proto,props){
			if (typeof props != 'undefined' && !isIE8) {
				// try {
				// 	throw 'The multple-arguement version of Object.create is not provided by this brower and cannot be shimmed.';
				// } catch (e) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _classCallCheck(instance, Constructor) {
	 	if (!(instance instanceof Constructor) && !isIE8) {
	 		try {
	...
	function _inherits(subClass, superClass) { 
		if (typeof superClass !== "function" && superClass !== null && !isIE8) {
			try {
